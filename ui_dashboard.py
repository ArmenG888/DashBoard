...
################################################################################
## Form generated from reading UI file 'dashboardiAyhTt.ui'
##
...
" } color:white;")
        ...
        self.average_mpg = QLabel(self.centralwidget)
        self.average_mpg.setObjectName(u"average_mpg")
        font3 = QFont()
        font3.setFamily(u"Segoe UI")
        font3.setPointSize(12)
        self.average_mpg.setFont(font3)
        self.average_mpg.setStyleSheet(u"color:white;")

        self.verticalLayout_2.addWidget(self.average_mpg)
        ...
        self.gallons = QLabel(self.centralwidget)
        self.gallons.setObjectName(u"gallons")
        self.gallons.setFont(font3)
        self.gallons.setStyleSheet(u"color:white;")

        self.verticalLayout_2.addWidget(self.gallons)
...
" }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.average_mpg.setText(QCoreApplication.translate("MainWindow", u"25 Mpg Average", None))
        self.current_mpg.setText(QCoreApplication.translate("MainWindow", u"15 Mpg Current", None))
        self.range.setText(QCoreApplication.translate("MainWindow", u"75 Range", None))
        self.gallons.setText(QCoreApplication.translate("MainWindow", u"5 Gallons", None))
        self.ethanol.setText(QCoreApplication.translate("MainWindow", u"15% Ethanol", None))
